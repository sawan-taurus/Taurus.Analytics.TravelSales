...
# MAGIC %%sql 
# MAGIC 
# MAGIC select date,count(*) from TaurusSilverLH.Oasis 
# MAGIC group by date 
# MAGIC 
...
# MAGIC %%sql 
# MAGIC 
# MAGIC select date,count(*) from TaurusSilverLH.Atoz
# MAGIC group by date 
...
# MAGIC %%sql 
# MAGIC 
# MAGIC select date,count(*) from TaurusSilverLH.Sales 
# MAGIC group by date 
...
# MAGIC %%sql 
# MAGIC -- delete from TaurusSilverLH.Sales
# MAGIC -- where Date = '2025-09-04'
