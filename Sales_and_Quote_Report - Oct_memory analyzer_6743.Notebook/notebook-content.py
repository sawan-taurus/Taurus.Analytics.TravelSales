...
dataset = "Sales_and_Quote_Report - Oct" # Enter the name or ID of the semantic model
workspace = "Taurus_TravelInsurance_Dev" # Enter the workspace name or ID in which the semantic model exists
