...
dim_destination = spark.read.format("delta").load(path_dim_destination).select("DestinationId", "Destination", "Brand")
...
# brand_agent_mapping = {
#     11: ["AMT Renewal", "Idol Compare Cover", "Idol Confused.com", "Idol Compare the Market",
#          "CYTI Moneysupermarket Medical", "CYTI Medical Travel Compared", "Switched On Insurance Direct",
#          "Direct AMT Renewal", "Idol Money", "Moneysupermarket",
#          "CYTI Medical Travel Compared Non Med", "Quotezone", "Idol Go Compare", "Idol Uswitch"],
#     10: ["Start AMT Renewal", "Start Direct AMT Renewal", "Start Compare Cover", "Start confused.com",
#          "Start Compare the Market", "Start CYTI MSM Medical", "Start Direct", "Start Go Compare",
#          "Start Money", "Start Moneysupermarket", "Start Medical Travel Compared", "Start Parent",
#          "Start Quotezone", "Start Uswitch"],
#     12: ["Trusted IDOL Compare Cover", "Trusted IDOL Confused", "Trusted IDOL Compare the Market",
#          "Trusted Direct", "Trusted Direct AMT Renewal", "Trusted IDOL Go Compare", "Trusted IDOL Money",
#          "Trusted Moneysupermarket", "Trusted CYTI Moneysupermarket Med", "Trusted Medical Travel Compared",
#          "Trusted AMT Renewal", "Trusted IDOL Uswitch"],
#     13: ["Viva IDOL Compare Cover", "Viva IDOL Confused", "Viva IDOL Compare the Market", "Viva Direct",
#          "Viva AMT Direct Renewal", "Viva IDOL Go Compare", "Viva IDOL Money", "Viva Moneysupermarket",
#          "Viva CYTI Moneysupermarket Med", "Viva Medical Travel Compared", "Viva AMT Renewal", "Viva IDOL Uswitch"],
#     14: ["Oasis Travel - Agg Renewal", "Oasis Travel - CYTI", "Oasis Travel - Direct",
#          "Oasis Travel - Direct Renewal", "Oasis Travel - IDOL COMPARE COVER", "Oasis Travel - IDOL CON",
#          "Oasis Travel - IDOL CTM", "Oasis Travel - IDOL GOC", "Oasis Travel - IDOL MONEY",
#          "Oasis Travel - IDOL USWITCH", "Oasis Travel - MSM", "Oasis Travel - MTC", "Oasis Travel - Quotezone"],
#     8:  ["AtoZ Direct AMT Renewal", "AtoZ IDOL AMT Renewal", "AtoZ Insurance Compare Cover",
#          "AtoZ Insurance Confused.com", "AtoZ Insurance CYTI-MSM", "AtoZ Insurance Direct",
#          "AtoZ Insurance Go Compare", "AtoZ Insurance IDOL CTM", "AtoZ Insurance Money",
#          "AtoZ Insurance MSM", "AtoZ Insurance MTC", "AtoZ Insurance Uswitch",
...
brand_agent_mapping = {
    11: ["AMT Renewal", "Idol Compare Cover", "Idol Confused.com", "Idol Compare the Market",
         ...
         "Direct AMT Renewal", "Idol Money", "Moneysupermarket",
         "CYTI Medical Travel Compared Non Med", "Quotezone", "Idol Go Compare", "Idol Uswitch",
         "Idol Holiday Ready", "Paying Too Much"],   # <-- ADDED
    10: ["Start AMT Renewal", "Start Direct AMT Renewal", "Start Compare Cover", "Start confused.com",
         "Start Compare the Market", "Start CYTI MSM Medical", "Start Direct", "Start Go Compare",
         "Start Money", "Start Moneysupermarket", "Start Medical Travel Compared", "Start Parent",
         "Start Quotezone", "Start Uswitch"],
    12: ["Trusted IDOL Compare Cover", "Trusted IDOL Confused", "Trusted IDOL Compare the Market",
         ...
         "Trusted Moneysupermarket", "Trusted CYTI Moneysupermarket Med", "Trusted Medical Travel Compared",
         "Trusted AMT Renewal", "Trusted IDOL Uswitch",
         "Trusted IDOL Holiday Ready"],   # <-- ADDED
    13: ["Viva IDOL Compare Cover", "Viva IDOL Confused", "Viva IDOL Compare the Market", "Viva Direct",
         "Viva AMT Direct Renewal", "Viva IDOL Go Compare", "Viva IDOL Money", "Viva Moneysupermarket",
         "Viva CYTI Moneysupermarket Med", "Viva Medical Travel Compared", "Viva AMT Renewal", "Viva IDOL Uswitch",
         "Viva IDOL Holiday Ready", "Viva Paying Too Much"],   # <-- ADDED
    14: ["Oasis Travel - Agg Renewal", "Oasis Travel - CYTI", "Oasis Travel - Direct",
         "Oasis Travel - Direct Renewal", "Oasis Travel - IDOL COMPARE COVER", "Oasis Travel - IDOL CON",
         "Oasis Travel - IDOL CTM", "Oasis Travel - IDOL GOC", "Oasis Travel - IDOL MONEY",
         "Oasis Travel - IDOL USWITCH", "Oasis Travel - MSM", "Oasis Travel - MTC", "Oasis Travel - Quotezone"],
...
for brand_id, agent_names in brand_agent_mapping.items():
    for agent_name in agent_names:
        cond = col("AgentName") == agent_name
        _brand_override = when(cond, lit(brand_id)) if _brand_override is None else _brand_override.when(cond, lit(brand_id))
...
fact_ready = (
    ...
    .withColumn(
        "TravelBrandId",
        _brand_override.otherwise(col("TravelBrandId")) if _brand_override is not None else col("TravelBrandId")
    )
    .join(
        broadcast(dim_destination),
        (src_df["MagentaDestination"] == dim_destination["Destination"]) &
        (
            ((col("TravelBrandId") == 12) & (dim_destination["Brand"] == lit("Trusted"))) |
            ((col("TravelBrandId") != 12) & (dim_destination["Brand"] == lit("All Other Brand")))
        ),
        "left"
    )
    ...
    .join(
        ...
        (
            ...
            (dim_marketing["Brand"] == lit("Taurus own Brands"))
        ),
        "left"
    )
)
