...
# DIM_Channel_TABLE = "DimChannel"
# DIM_ProductType_TABLE = "DimProductType"

# FACT_TABLE = "FactDailySales"
...
# # Set processing date
# PROCESS_DATE = "2025-04-01"  # change this as needed
...
# # Prepare new fact data for that day
# fact_df = silver_df.join(dim_product_brand_df, "ProductBrand", "inner") \
...
# fact_df_aggregated = fact_df.groupBy("ProductBrandID", "DateId").agg(
...
# print(f"FactDailySales table updated for {PROCESS_DATE} (DateId = {date_id})")
...
print(f"FactDailySales table updated for {PROCESS_DATE} (DateId = {date_id}) with all dimensions added.")
